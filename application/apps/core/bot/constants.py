...
user_status_to_button_labels_for_menu_keyboard = {
    ...
    "registered": [*permanent_button_labels, "Заказать торт"],
...
state_code_to_text_message = {
    ...
    "5.1": 'Можете перейти к сборке торта.',
    ...
    "16": 'Так и запишем:)',
    "17": 'Торт собран. Для оформления заказа пройдите регистрацию, нажав на кнопку ниже',
    "18": 'Торт собран. Узнайте цену, нажав "Заказать торт"',
}
